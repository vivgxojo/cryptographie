import pytest
from crypto import hasher_mots, chiffrement_cesar

#test césar
@pytest.mark.parametrize("chaine, nb_cesar,  resultat_attendu", [
    ("abc", 0,  "abc"),
    ("abc", 1, "bcd"),
    ("abc", -1, "zab"),
    ("az", 1, "ba"),
...
def test_fonction(chaine, nb_cesar, resultat_attendu):
    resultat = chiffrement_cesar(chaine, nb_cesar)
    assert resultat == resultat_attendu

# tests hash
def test_hash_1():
    ls_mots =  [ "arbre", "bateau"]
